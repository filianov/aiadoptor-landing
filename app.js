...
const translations = {
  en: {
    ...
    "audience.title": "For people who need AI in real life",
  ...
  de: {
    ...
    "audience.title": "Für Menschen, die AI im echten Leben brauchen",
  ...
  ru: {
    ...
    "hero.title": "Практические AI-процессы для повседневных задач, работы и малого бизнеса",
    "hero.copy":
    ...
    "audience.title": "Для людей, которым нужен AI в реальной жизни",
  ...
  uk: {
    ...
    "hero.title": "Практичні AI-процеси для повсякденних завдань, роботи та малого бізнесу",
    "hero.copy":
    ...
    "audience.title": "Для людей, яким потрібен AI у реальному житті",
