...
const translations = {
  en: {
    ...
    "hero.title": "Practical AI Workflows for Everyday Tasks, Work and Small Business",
    "hero.copy":
      "AIAdoptor helps international business professionals and small businesses in Vienna save time and automate repetitive work with practical AI workflows — in English, Russian or Ukrainian.",
    ...
    "audience.title": "For people who need AI to work in real life, not in demos",
    ...
    "workflows.copy":
      "The goal is not to collect tools. The goal is to save time, reduce friction and improve the quality of communication, documents and decisions.",
  ...
  de: {
    ...
    "hero.title": "Praktische AI-Workflows für Alltagsaufgaben, Arbeit und kleine Unternehmen",
    "hero.copy":
      "AIAdoptor hilft internationalen Business Professionals und kleinen Unternehmen in Wien, Zeit zu sparen und repetitive Arbeit mit praktischen AI-Workflows zu automatisieren — auf Englisch, Russisch oder Ukrainisch.",
    "hero.signalsAria": "Service-Highlights",
    ...
    "audience.title": "Für Menschen, bei denen AI im echten Alltag funktionieren muss, nicht nur in Demos",
    ...
    "workflows.copy":
      "Das Ziel ist nicht, Tools zu sammeln. Das Ziel ist, Zeit zu sparen, Reibung zu reduzieren und die Qualität von Kommunikation, Dokumenten und Entscheidungen zu verbessern.",
  ...
  ru: {
    ...
    "hero.title": "Практические AI-воркфлоу для повседневных задач, работы и малого бизнеса",
    "hero.copy":
      "AIAdoptor помогает международным бизнес-профессионалам и малому бизнесу в Вене экономить время и автоматизировать повторяющуюся работу с помощью практических AI-воркфлоу — на английском, русском или украинском.",
    ...
    "audience.title": "Для людей, которым нужен AI в реальной жизни, а не в демо",
    ...
    "workflows.copy":
      "Цель не в том, чтобы собирать инструменты. Цель — экономить время, снижать трение и повышать качество коммуникации, документов и решений.",
    ...
    "why.title": "Достаточно технический, чтобы построить, и достаточно бизнесовый, чтобы это было полезно",
  ...
  uk: {
    ...
    "hero.title": "Практичні AI-воркфлоу для повсякденних задач, роботи та малого бізнесу",
    "hero.copy":
      "AIAdoptor допомагає міжнародним бізнес-професіоналам і малому бізнесу у Відні економити час та автоматизувати повторювану роботу за допомогою практичних AI-воркфлоу — англійською, російською або українською.",
    ...
    "audience.title": "Для людей, яким потрібен AI у реальному житті, а не в демо",
    ...
    "workflows.copy":
      "Мета не в тому, щоб збирати інструменти. Мета — економити час, зменшувати тертя та покращувати якість комунікації, документів і рішень.",
    ...
    "why.title": "Достатньо технічний, щоб побудувати, і достатньо бізнесовий, щоб це було корисно",
